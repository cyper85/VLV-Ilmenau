        ...
        <?php foreach ($this->js as $js)
            ...
            <body>
                <div class="container" id="page">
                    ...
                    <div id="mainmenu">
                        <ul id="yw0">
                            <li<?php if (\filter_input(INPUT_SERVER, 'SCRIPT_NAME') === "/index.php") {
            echo " class='active'";
        } ?>><a href="/">Vorlesungsverzeichnis</a></li>
                            <?php if ($this->getUser()) { ?>
                                <li<?php if (\filter_input(INPUT_SERVER, 'SCRIPT_NAME') === "/settings.php") {
                                    echo " class='active'";
                                } ?>><a href="settings.php">Einstellungen</a></li>
            <?php if ($this->isSu()): ?>			<li<?php if (\filter_input(INPUT_SERVER, 'SCRIPT_NAME') === "/literatur.php") {
                    echo " class='active'";
                } ?>><a href="literatur.php">Literatur</a></li> <?php endif; ?>						
                                <li><a href="logout.php">Logout (<?= $this->getUser() ?>)</a></li>
                        <?php } else { ?>						
                                <li<?php if (\filter_input(INPUT_SERVER, 'SCRIPT_NAME') === "/login.php") {
                    echo " class='active'";
                } ?>><a href="login.php">Login</a></li>
                                <li<?php if ((\filter_input(INPUT_SERVER, 'SCRIPT_NAME') === "/register.php") OR ( \filter_input(INPUT_SERVER, 'SCRIPT_NAME') === "/register_done.php")) {
                    echo " class='active'";
                } ?>><a href="register.php">Registrierung</a></li>
        <?php } ?>					
                            <li<?php if (\filter_input(INPUT_SERVER, 'SCRIPT_NAME') === "/impressum.php") {
            echo " class='active'";
